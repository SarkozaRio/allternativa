            ...
            <div class="page-header">
              <h1 id="tables">Visualizar Usuário</h1>
                ...
                <div class="col-xs-3 col-sm-1 col-md-1">Id:</div>
                 ...
                 <div class="col-xs-9 col-sm-11 col-md-11"><?php echo $result['nome']; ?></div>
                 ...
                 <div class="col-xs-9 col-sm-11 col-md-11"><?php echo $result['login']; ?></div>
                 <div class="col-xs-3 col-sm-1 col-md-1">Senha:</div>
                 <div class="col-xs-9 col-sm-11 col-md-11"><?php echo $result['senha']; ?></div>
                 <div class="col-xs-3 col-sm-1 col-md-1">Nivel Acesso:</div>
                 <div class="col-xs-9 col-sm-11 col-md-11"><?php echo $result['nivel_acesso_id']; ?></div>
                 ...
                 <div class="pull-right">
                   ...
                   <a href ='administrativo.php?link=4&id=<?php echo $result['id']; ?>'><button type='button' class='btn btn-warning  btn-sm'>Editar</button></a>
